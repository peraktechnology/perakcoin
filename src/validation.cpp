...
#if defined(NDEBUG)
# error "Perakcoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Perakcoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s PRK additional fees, %d delta bytes\n",
