...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.perakcoin.loshan.co.uk", true);
        vSeeds.emplace_back("dnsseed.thrasher.io", true);
        vSeeds.emplace_back("dnsseed.perakcointools.com", true);
        vSeeds.emplace_back("dnsseed.perakcoinpool.org", true);
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.perakcointools.com", true);
        vSeeds.emplace_back("seed-b.perakcoin.loshan.co.uk", true);
