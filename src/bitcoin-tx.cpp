...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s perakcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  perakcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded perakcoin transaction") + "\n" +
              "  perakcoin-tx [options] -create [commands]   " + _("Create hex-encoded perakcoin transaction") + "\n" +
              "\n";
